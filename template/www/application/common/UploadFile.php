    ...
    private function save($file)
    {
        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
                ...
                $thumbFile			=	$this->thumbFile?$this->thumbFile:$file['savename'];
                ...
                for($i=0,$len=count($thumbWidth); $i<$len; $i++) {
                    ...
                    $thinkImage = \think\Image::open($filename);
                    $thinkImage->thumb($thumbWidth[$i],$thumbHeight[$i])->save($thumbname);
                }
