<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wamp\wwwroot\www/application/admin\view\Index\form_editors.html";i:1555556757;}*/ ?>
...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/public/static/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" class="form-horizontal" action="<?php echo url('User/insert'); ?>">
