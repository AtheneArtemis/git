...
class MemberUpgradeOrder extends Publictable{
    
    function _initialize(){
        parent::_initialize();
        $this->model = 'member_upgrade_order';
        $this->controllername = '会员升级套餐订单列表';
        ...
        foreach ($list as $k1 => $v1) {
            ...
            $excelSpec[$k1] = [
                ...
                'H' => [
                    'width' => 100,
                    'title' => '商品信息',
                    'content' => '商品名称：'.$v1['product']['name'].' 数量：1'
                ],
                // 'I' => [
                //     'width' => 100,
                //     'title' => '',
