...
(function(D, B) {
    function A(E) {
        return !D(E).parents().andSelf().filter(function() {
    ...
    D.fn.extend({
        ...
        scrollParent: function() {
            var E;
            D.browser.msie && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? E = this.parents().filter(function() {
        ...
        disableSelection: function() {
            return this.bind((D.support.selectstart ? "selectstart" : "mousedown") + ".ui-disableSelection", function(E) {
                E.preventDefault()
            })
        },
    ...
    D.each(["Width", "Height"], function(I, F) {
        function E(L, M, K, N) {
            D.each(G, function() {
                ...
                K && (M -= parseFloat(D.curCSS(L, "border" + this + "Width", !0)) || 0),
    ...
    D.extend(D.ui, {
        plugin: {
            add: function(G, H, E) {
                ...
                for (var I in E) {
                    F.plugins[I] = F.plugins[I] || [],
                    F.plugins[I].push([H, E[I]])
                }
            },
            call: function(I, G, H) {
                var E = I.plugins[G];
...
(function(D, B) {
    if (D.cleanData) {
        ...
        D.fn.remove = function(E, F) {
            return this.each(function() {
                F || (!E || D.filter(E, [this]).length) && D("*", this).add([this]).each(function() {
                    try {
    ...
    D.Widget.prototype = {
        ...
        _createWidget: function(F, G) {
            ...
            this.element = D(G),
            this.options = D.extend(!0, {}, this.options, this._getCreateOptions(), F);
            var E = this;
        ...
        _setOption: function(F, E) {
            this.options[F] = E,
            F === "disabled" && this.widget()[E ? "addClass" : "removeClass"](this.widgetBaseClass + "-disabled ui-state-disabled").attr("aria-disabled", E);
            return this
        },
        enable: function() {
    ...
    C.widget("ui.mouse", {
        ...
        _mouseDown: function(F) {
            if (!B) {
                ...
                !0 === C.data(F.target, this.widgetName + ".preventClickEvent") && C.removeData(F.target, this.widgetName + ".preventClickEvent"),
        ...
        _mouseMove: function(D) {
            ...
            this._mouseDistanceMet(D) && this._mouseDelayMet(D) && (this._mouseStarted = this._mouseStart(this._mouseDownEvent, D) !== !1,
        ...
        _mouseUp: function(D) {
            ...
            D.target == this._mouseDownEvent.target && C.data(D.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(D));
            return !1
        },
...
(function(B, A) {
    B.widget("ui.draggable", B.ui.mouse, {
        ...
        _mouseCapture: function(D) {
            var C = this.options;
            if (this.helper || C.disabled || B(D.target).is(".ui-resizable-handle,.ui-resizable-handle>.knob")) {
                return false
            }
        ...
        _convertPositionTo: function(C, E) {
            ...
            return {
                top: (E.top + this.offset.relative.top * H + this.offset.parent.top * H - (B.browser.safari && B.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : (F ? 0 : G.scrollTop())) * H)),
                left: (E.left + this.offset.relative.left * H + this.offset.parent.left * H - (B.browser.safari && B.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : F ? 0 : G.scrollLeft()) * H))
            }
        },
        _generatePosition: function(G) {
            ...
            return {
                top: (H - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (B.browser.safari && B.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : (C ? 0 : L.scrollTop())))),
                left: (I - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (B.browser.safari && B.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : C ? 0 : L.scrollLeft())))
            }
        },
        _clear: function() {
        ...
        start: function(H, D) {
            ...
            B(this).unbind("layersnapstart").bind("layersnapstart", function() {
                ...
                if (B.getElementAreaInf(B(this)) == "canvas") {
                    ...
                    B("#scroll_container .cstlayer:not(.ui-modselected)").each(function() {
                        I(B(this))
                    })
                }
                J.snapElements = [];
...
(function(B, A) {
    B.widget("ui.droppable", {
        ...
        _setOption: function(C, D) {
            C == "accept" && (this.accept = B.isFunction(D) ? D : function(E) {
                return E.is(D)
            }
            ),
        ...
        _over: function(C) {
            var D = B.ui.ddmanager.current;
            !!D && (D.currentItem || D.element)[0] != this.element[0] && this.accept.call(this.element[0], D.currentItem || D.element) && (this.options.hoverClass && this.element.addClass(this.options.hoverClass),
            this._trigger("over", C, this.ui(D)))
        },
        _out: function(C) {
            var D = B.ui.ddmanager.current;
            !!D && (D.currentItem || D.element)[0] != this.element[0] && this.accept.call(this.element[0], D.currentItem || D.element) && (this.options.hoverClass && this.element.removeClass(this.options.hoverClass),
        ...
        _drop: function(E, F) {
            ...
            this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                if (G.options.greedy && !G.options.disabled && G.options.scope == C.options.scope && G.accept.call(G.element[0], C.currentItem || C.element) && B.ui.intersect(C, B.extend(G, {
    ...
    B.ui.ddmanager = {
        ...
        prepareOffsets: function(G, H) {
            ...
            droppablesLoop: for (var C = 0; C < D.length; C++) {
                if (D[C].options.disabled || G && !D[C].accept.call(D[C].element[0], G.currentItem || G.element)) {
                    continue
                }
        ...
        drop: function(D, E) {
            ...
            B.each(B.ui.ddmanager.droppables[D.options.scope] || [], function() {
                !this.options || (!this.options.disabled && this.visible && B.ui.intersect(D, this, this.options.tolerance) && (C = this._drop.call(this, E) || C),
                !this.options.disabled && this.visible && this.accept.call(this.element[0], D.currentItem || D.element) && (this.isout = 1,
                this.isover = 0,
            ...
            B.each(B.ui.ddmanager.droppables[C.options.scope] || [], function() {
                if (!(this.options.disabled || this.greedyChild || !this.visible)) {
                    ...
                    if (this.options.greedy) {
                        ...
                        E.length && (H = B.data(E[0], "droppable"),
                        H.greedyChild = G == "isover" ? 1 : 0)
                    }
                    H && G == "isover" && (H.isover = 0,
                    H.isout = 1,
                    H._out.call(H, D)),
                    this[G] = 1,
...
(function(D, B) {
    D.widget("ui.resizable", D.ui.mouse, {
        ...
        _create: function() {
            ...
            this.handles = H.handles || (!D(".ui-resizable-handle", this.element).length ? "e,s,se" : {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
                w: ".ui-resizable-w",
        ...
        _mouseDrag: function(H) {
            var J = this.helper
              ...
              , Q = this.axis;
            var K = H.pageY;
            if (L.scroll && (!L.concernAngle || L.concernAngle && !this.element.data("deg"))) {
        ...
        _proportionallyResize: function() {
            ...
            for (var E = 0; E < this._proportionallyResizeElements.length; E++) {
                ...
                if (D.browser.msie && !(!(D(I).is(":hidden") || D(I).parents(":hidden").length))) {
                    continue
                }
                J.css({
        ...
        _change: {
            e: function(I, G, E) {
                ...
                if (F.concernAngle && this.element.data("deg")) {
                    return D.divrotate.getDegreeResizeChange(this.element, [G, E], H, J, "e")
                }
                return {
            ...
            w: function(I, G, E) {
                var F = this.options
                  ...
                  , H = this.originalPosition;
                if (F.concernAngle && this.element.data("deg")) {
                    return D.divrotate.getDegreeResizeChange(this.element, [G, E], H, J, "w")
                }
                return {
                    left: H.left + G,
                    width: J.width - G
            ...
            n: function(I, G, E) {
                var F = this.options
                  ...
                  , H = this.originalPosition;
                if (F.concernAngle && this.element.data("deg")) {
                    return D.divrotate.getDegreeResizeChange(this.element, [G, E], H, J, "n")
                } else {
                    return {
                        top: H.top + E,
                        height: J.height - E
            ...
            s: function(I, G, E) {
                var F = this.options
                  ...
                  , H = this.originalPosition;
                if (F.concernAngle && this.element.data("deg")) {
                    return D.divrotate.getDegreeResizeChange(this.element, [G, E], H, J, "s")
                }
                return {
    ...
    D.ui.plugin.add("resizable", "animate", {
        stop: function(H, G) {
            ...
            var K = {
                width: (N.size.width - O),
                height: (N.size.height - L)
            }
            ...
            N.element.animate(D.extend(K, I && J ? {
                top: I,
                left: J
            } : {}), {
    ...
    D.ui.plugin.add("resizable", "scroll", {
        start: function(G, E) {
            var F = D(this).data("resizable");
            o = F.options;
            if (o.scroll && (!o.concernAngle || o.concernAngle && !F.element.data("deg"))) {
                F.scrollout = 1;
        ...
        start: function(I, F) {
            ...
            D(this).unbind("layersnapstart").bind("layersnapstart", function() {
                ...
                if (D.getElementAreaInf(D(this)) == "canvas") {
                    ...
                    D("#scroll_container .cstlayer:not(.ui-modselected)").each(function() {
                        J(D(this))
                    })
                }
                K.snapElements = [];
...
(function(C, A) {
    ...
    C.widget("ui.slider", C.ui.mouse, {
        ...
        _create: function() {
            ...
            this.range = C([]),
            E.range && (E.range === !0 && (E.values || (E.values = [this._valueMin(), this._valueMin()]),
            E.values.length && E.values.length !== 2 && (E.values = [E.values[0], E.values[0]])),
            this.range = C("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header" + (E.range === "min" || E.range === "max" ? " ui-slider-range-" + E.range : "")));
            ...
            this.handles.add(this.range).filter("a").click(function(K) {
                ...
                E.disabled ? C(this).blur() : (C(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),
            ...
            this.handles.keydown(function(L) {
                var M = !0, Q = C(this).data("index.ui-slider-handle"), K, N, O, P;
                if (!I.options.disabled) {
                    ...
                    P = I.options.step,
                    I.options.values && I.options.values.length ? N = O = I.values(Q) : N = O = I.value();
                    switch (L.keyCode) {
                    case C.ui.keyCode.HOME:
                        O = I._valueMin();
                        break;
        ...
        _mouseCapture: function(J) {
            var K = this.options, N, D, L, M, G, H, E, F, I;
            if (K.disabled) {
                return !1
            }
            this.elementSize = {
            ...
            K.range === !0 && this.values(1) === K.min && (H += 1,
            M = C(this.handles[H])),
            E = this._start(J, H);
            if (E === !1) {
                return !1
            ...
            this._clickOffset = I ? {
                ...
                top: J.pageY - F.top - M.height() / 2 - (parseInt(M.css("borderTopWidth"), 10) || 0) - (parseInt(M.css("borderBottomWidth"), 10) || 0) + (parseInt(M.css("marginTop"), 10) || 0)
            },
        ...
        _normValueFromMouse: function(H) {
            var F, G, D, E, I;
            this.orientation === "horizontal" ? (F = this.elementSize.width,
            G = H.x - this.elementOffset.left - (this._clickOffset ? this._clickOffset.left : 0)) : (F = this.elementSize.height,
            G = H.y - this.elementOffset.top - (this._clickOffset ? this._clickOffset.top : 0)),
            D = G / F,
            D > 1 && (D = 1),
            D < 0 && (D = 0),
        ...
        _start: function(F, D) {
            ...
            this.options.values && this.options.values.length && (E.value = this.values(D),
        ...
        _slide: function(H, F, G) {
            ...
            this.options.values.length === 2 && this.options.range === !0 && (F === 0 && G > D || F === 1 && G < D) && (G = D),
            G !== this.values(F) && (E = this.values(),
            E[F] = G,
            ...
            D = this.values(F ? 0 : 1),
            I !== !1 && this.values(F, G, !0))) : G !== this.value() && (I = this._trigger("slide", H, {
                handle: this.handles[F],
                value: G
            }),
            I !== !1 && this.value(G))
        ...
        _setOption: function(F, G) {
            ...
            switch (F) {
            case "disabled":
                G ? (this.handles.filter(".ui-state-focus").blur(),
        ...
        _refreshValue: function() {
            var I = this.options.range, J = this.options, M = this, D = this._animateOff ? !1 : J.animate, K, L = {}, G, H, E, F;
            this.options.values && this.options.values.length ? this.handles.each(function(O, N) {
                K = (M.values(O) - M._valueMin()) / (M._valueMax() - M._valueMin()) * 100,
                L[M.orientation === "horizontal" ? "left" : "bottom"] = K + "%",
                C(this).stop(1, 1)[D ? "animate" : "css"](L, J.animate),
                M.options.range === !0 && (M.orientation === "horizontal" ? (O === 0 && M.range.stop(1, 1)[D ? "animate" : "css"]({
                    left: K + "%"
                }, J.animate),
                O === 1 && M.range[D ? "animate" : "css"]({
                    width: K - G + "%"
                }, {
                    queue: !1,
                    duration: J.animate
                })) : (O === 0 && M.range.stop(1, 1)[D ? "animate" : "css"]({
                    bottom: K + "%"
                }, J.animate),
                O === 1 && M.range[D ? "animate" : "css"]({
                    height: K - G + "%"
            ...
            I === "min" && this.orientation === "horizontal" && this.range.stop(1, 1)[D ? "animate" : "css"]({
                width: K + "%"
            }, J.animate),
            I === "max" && this.orientation === "horizontal" && this.range[D ? "animate" : "css"]({
                width: 100 - K + "%"
            }, {
                queue: !1,
                duration: J.animate
            }),
            I === "min" && this.orientation === "vertical" && this.range.stop(1, 1)[D ? "animate" : "css"]({
                height: K + "%"
            }, J.animate),
            I === "max" && this.orientation === "vertical" && this.range[D ? "animate" : "css"]({
                height: 100 - K + "%"
            }, {
                queue: !1,
                duration: J.animate
...
(function(E, C) {
    ...
    E.fn.position = function(P) {
        ...
        P = E.extend({}, P);
        var K = E(P.of), L = K[0], I = (P.collision || "flip").split(" "), J = P.offset ? P.offset.split(" ") : [0, 0], N, O, M;
        L.nodeType === 9 ? (N = K.width(),
        O = K.height(),
        M = {
            top: 0,
            left: 0
        }) : L.setTimeout ? (N = K.width(),
        O = K.height(),
        M = {
            top: K.scrollTop(),
            left: K.scrollLeft()
        }) : L.preventDefault ? (P.at = "left top",
        N = O = 0,
        M = {
            top: P.of.pageY,
            left: P.of.pageX
        ...
        E.each(["my", "at"], function() {
            var Q = (P[this] || "").split(" ");
            Q.length === 1 && (Q = D.test(Q[0]) ? Q.concat([A]) : H.test(Q[0]) ? [A].concat(Q) : [A, A]),
        ...
        M.top += J[1];
        return this.each(function() {
            var W = E(this), Y = W.outerWidth(), X = W.outerHeight(), T = parseInt(E.curCSS(this, "marginLeft", !0)) || 0, U = parseInt(E.curCSS(this, "marginTop", !0)) || 0, V = Y + T + (parseInt(E.curCSS(this, "marginRight", !0)) || 0), R = X + U + (parseInt(E.curCSS(this, "marginBottom", !0)) || 0), S = E.extend({}, M), Q;
            P.my[0] === "right" ? S.left -= Y : P.my[0] === A && (S.left -= Y / 2),
            P.my[1] === "bottom" ? S.top -= X : P.my[1] === A && (S.top -= X / 2),
            F.fractions || (S.left = Math.round(S.left),
            ...
            E.each(["left", "top"], function(a, Z) {
                E.ui.position[I[a]] && E.ui.position[I[a]][Z](S, {
                    targetWidth: N,
                    targetHeight: O,
                    elemWidth: Y,
                    elemHeight: X,
    ...
    function() {
        var M = document.getElementsByTagName("body")[0], N = document.createElement("div"), P, I, O, K, L;
...
(function(D, E) {
    ...
    D.widget("ui.autocomplete", {
        ...
        pending: 0,
        _create: function() {
            var A = this, B = this.element[0].ownerDocument, C;
                ...
                if (!D(J.target).closest(".ui-menu-item").length) {
                    setTimeout(function() {
                        D(document).one("mousedown", function(G) {
                            if (G.target !== A.element[0] && G.target !== I && !D.ui.contains(I, G.target)) {
                                A.close()
                            }
                        })
                    }, 1)
        ...
        _setOption: function(B, A) {
            ...
            if (B === "appendTo") {
                this.menu.element.appendTo(D(A || "body", this.element[0].ownerDocument)[0])
            }
        ...
        _resizeMenu: function() {
            ...
            if (this.options.width == "auto") {
                ...
                A.outerWidth(this.options.width).css({
                    "overflow-x": "hidden"
                })
            }
        },
        ...
        _renderItem: function(B, A) {
            return D("<li></li>").data("item.autocomplete", A).append(D("<a></a>").text(A.label)).appendTo(B)
        },
        _move: function(A, B) {
            if (!this.menu.element.is(":visible")) {
                this.search(null, B);
    ...
    B.widget("ui.menu", {
        ...
        nextPage: function(F) {
            if (this.hasScroll()) {
                ...
                this.activate(F, this.element.children(".ui-menu-item").filter(!this.active || this.last() ? ":first" : ":last"))
            }
        },
            ...
            elements.each(function() {
                ...
                if ($('.fullpage_alllist').length) {
                    ...
                    if ($this.offset().top - fold < 0) {
                        ...
                        counter = 0;
                    } else if ($.abovethetop(this, settings) || $.leftofbegin(this, settings)) {/* Nothing. */
...
;(function(E, C) {
    ...
    E.divrotate = function(L, G, M, F) {
        ...
        if (E.browser.safari || E.browser.mozilla || E.browser.opera || (E.browser.msie && E.browser.version == "9.0")) {
            ieRotate({
                degree: G,
                dom: L
            })
                ...
                if (R <= 90) {
                    if (X > 0) {
                        F = {
                            ...
                            left: Math.round(Z + P * E.math.sin(R) - (J + P) * E.math.sin(R)),
                    ...
                    if (R > 270 && R < 360) {
                        ...
                        if (R > 90 && R <= 180) {
                            if (X > 0) {
                                F = {
                                    height: Math.round(J - P),
                                    left: Math.round(Z - P * E.math.sin(R) - (J - P) * E.math.sin(R) + G * E.math.cos(R)),
                                    top: Math.round(H + P * E.math.cos(R) + (J - P) * E.math.cos(R))
                                }
                            } else {
                                if (X < 0) {
                                    F = {
                            ...
                            if (R > 180 && R <= 270) {
                                if (X > 0) {
                                    F = {
                                        height: Math.round(J - P),
                                        left: Math.round(Z - P * E.math.sin(R) + G * E.math.cos(R)),
                                        top: Math.round(H + P * E.math.cos(R) + (J - P) * E.math.cos(R) + G * E.math.sin(R))
                                    }
                                } else {
                                    if (X < 0) {
                                        F = {
                    ...
                    if (R > 90 && R <= 180) {
                        if (X > 0) {
                            F = {
                                width: G,
                                height: Math.round(J + P),
                                left: Math.round(Z - (J + P) * E.math.sin(R) + G * E.math.cos(R)),
                        ...
                        if (R > 180 && R <= 270) {
                            if (X > 0) {
                                F = {
                                    ...
                                    top: Math.round(H + (J + P) * E.math.cos(R) + G * E.math.sin(R))
                                }
                            } else {
                                if (X < 0) {
                                    F = {
                    ...
                    if (R > 90 && R <= 180) {
                        if (X > 0) {
                            F = {
                                width: Math.round(G + P),
                                height: J,
                                left: Math.round(Z - P * E.math.cos(R) - J * E.math.sin(R) + (G + P) * E.math.cos(R)),
                        ...
                        if (R > 180 && R <= 270) {
                            if (X > 0) {
                                F = {
                                    width: Math.round(G - P),
                                    height: J,
                                    left: Math.round(Z + P * E.math.cos(R) + (G - P) * E.math.cos(R)),
                                    top: Math.round(H + P * E.math.sin(R) + (G - P) * E.math.sin(R) + J * E.math.cos(R))
                                }
                            } else {
                                if (X < 0) {
                                    F = {
                            ...
                            if (R > 270 && R < 360) {
                                if (X > 0) {
                                    F = {
                                        ...
                                        top: Math.round(H + P * E.math.sin(R) - (G - P) * E.math.cos(R))
                                    }
                                } else {
                                    if (X < 0) {
                                        F = {
...
function toolbarRotate(M, T, A, P) {
    ...
    if ($.browser.msie && $.browser.version < 9) {
        ...
        P.css({
            filter: "progid:DXImageTransform.Microsoft.Matrix(M11=" + V + ",M12=" + (-O) + ",M21=" + O + ",M22=" + V + ",SizingMethod='auto expand')",
            "left": B + "px",
            "top": X + "px"
        })
    } else {
        ...
        if (M.attr("fatherid") && M.attr("fatherid") != "" && $("#" + M.attr("fatherid")).is(".cstlayer")) {
            S = R
        }
...
function modPosRotate(K, R, B) {
    ...
    if ($.browser.msie && $.browser.version < 9) {
        ...
        $(".posblk").css({
            filter: "progid:DXImageTransform.Microsoft.Matrix(M11=" + A + ",M12=" + (-N) + ",M21=" + N + ",M22=" + A + ",SizingMethod='auto expand')",
            "left": P + "px",
            "top": C + "px"
        })
    } else {
    ...
    $(window).load(function() {
        ...
        if (heightadaptel.length) {
            heightadaptel.each(function() {
                if ($(this).data('not_need_heightadapt'))
                    return;
                wp_heightAdapt($(this));
            })
...
function wpfullcolumn_float() {
    ...
    $('.full_column,.cstlayer').filter('[infixed=1]').each(function() {
        ...
        if (isinfixed == 1) {
            ...
            if (oPos == 0 && $fc_lid.parent().is('#canvas'))
                return;
            if (oPos == 0) {
            ...
            if (inbuttom > 0) {
                ...
                if (nPos > oPos) {
                    ...
                    if (wp_layer_abs_footer.length > 0) {
                        ...
                        wp_layer_fix = wp_layer_abs_footer.clone(true).appendTo(container).attr('oldstyle', oldstyle).attr('inbuttom', '1').addClass('full_column-fixed');
                    ...
                    if (wp_layer_abs_footer.length == 0) {
                        ...
                        wp_layer_abs_footer = wp_layer_fix.clone(true).appendTo(wp_icontent_foot).attr('style', oldstyle).attr('inbuttom', '1').removeClass('full_column-fixed');
                        if (wp_layer_fix.attr('fatherid')) {
                ...
                if (nPos > oPos) {
                    ...
                    if (wp_layer_abs.length > 0) {
                        ...
                        wp_layer_abs.remove();
                        var wp_layer_fix = $(fc_lid).html(infixed_html).attr('oldstyle', oldstyle).addClass('full_column-fixed');
                        wp_layer_fix.show();
                        wp_layer_fix.css({
                            'position': 'fixed',
                            'top': '',
                        ...
                        var funco = function() {
                            ...
                            if (!full_width_val) {
                                $(fc_lid).children('.full_width').css({
                                    left: 0 - $('#canvas').offset().left - $.parseInteger($('#canvas').css("borderLeftWidth")),
                    ...
                    if (!wp_layer_abs.length > 0) {
                        ...
                        if (!wp_icontent.length)
                            wp_icontent = $('#canvas');
                        wp_icontent.append(layerdiv);
                        wp_layer_fix.remove();
                        wp_layer_abs = $(fc_lid).html(infixed_html).attr('oldstyle', oldstyle).removeClass('full_column-fixed');
                        wp_layer_abs.show();
                        //为空异常处理
                        var funco = function() {
                            var full_width_val = Math.abs(parseFloat($(fc_lid).find('.full_width').css('left')));
        ...
        setTimeout(function() {
            $('.full_column,.cstlayer').filter('[infixed=1]').each(function() {
                ...
                if (self.parent().is('#canvas') && parseInt(self.css('top')) == 0) {
                    ...
                    wp_layer_abs.remove();
                    container.append(layerdiv);
                    var wp_layer_fix = $('#' + layerid).html(layerhtml).attr('oldstyle', oldstyle).addClass('full_column-fixed');
                    ...
                    if ($.browser.msie && ($.browser.version < 9)) {
                        ...
                        wp_layer_fix.find('.full_width').css({
                            'top': '0px'
                        });
                    }
                    var ismobile = is_website_mobile();
                    ...
                    if (!ismobile)
                        imgcontainer = $('#scroll_container').add(window);
...
(function() {
    function resizeCanvasHeight() {
        ...
        var container = $('#scroll_container');
        // 画布高度
        var cvhgt = window.getdeviceheight || window.innerHeight || self.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
        //$(window).height();
        ...
        if ($('#site_footer').length > 0) {
            ...
            canvheight = Math.max($("#canvas").data('layermaxheight'), cvhgt - mfooterheight);
    ...
    function correctFooterPos() {
        ...
        $('#site_footer').css({
            left: canv.offset().left - containerOffsetLeft + $('#scroll_container').scrollLeft() + $.parseInteger($('#canvas').css("borderLeftWidth")),
            top: canvheight
        });
        $('#site_footer >.full_width').css({
            left: 0 - canv.offset().left + containerOffsetLeft - $('#scroll_container').scrollLeft() - $.parseInteger($('#canvas').css("borderLeftWidth")),
...
function wp_pages_global_func(params) {
    ...
    window['relativeToAbsoluteURL'] = function(relativeurl, nostatic) {
        if (nostatic == '1')
            return params['p_rooturl'] + "/" + relativeurl;
        else
            return params['static_rooturl'] + "/" + relativeurl;
    }
    ;
...
function wp_confirm(message, callback, cancelBack) {
    ...
    pnl = '<div id="wp-confirm_panel" class="overz wp-manage_panel wp-alert-panel" style="position:absolute;width:' + width + 'px;z-index:10001;">' + '<div class="wp-panel_outpadding overz"><div class="wp-manage_panel_block_one wp-manage-link overz"><h2 class="overz">' + message + '</h2></div>' + '<div class="wp-alert_button overz"><a href="javascript:;" class="wp-alert-sure">' + translate('Sure') + '</a><a href="javascript:;" class="wp-alert-cancel">' + translate('Cancel') + '</a></div></div></div>';
            ...
            if (name.match(/,/)) {
                ...
                $('a.wp-alert-edit', self).hover(function() {
                    ...
                    $('a.wp-alert-edit', self).css({
                        "color": "#FFF",
                        "background": "url(../images/wp-button-bg-hover.gif) repeat-x #366bbc"
                    });
                ...
                $cpnl.find('a.wp-alert-sure').click(function(e) {
                    ...
                    if (resetWtimer)
                        clearTimeout(resetWtimer);
                    e.preventDefault();
                }).end().find('a.wp-alert-cancel').click(function(e) {
                    if (cancelBack && $.isFunction(cancelBack))
                        cancelBack();
                    $cpnl.add('#wp-confirmpnl_overlay').remove();
                    if (resetWtimer)
                        clearTimeout(resetWtimer);
    ...
    $(document).keydown(function(e) {
        if (e.keyCode == 13)
            $cpnl.find('a.wp-alert-sure').trigger('click');
    });
    return false;
}

function wp_editPicOnline(param) {
    var imgtype = parseInt(getImageProcessType()) || 0;
    //图片处理  0 使用aviary处理  1 使用美图秀秀处理
    var imgprocess = ['feather', 'xiuxiu'];
    if (imgtype >= imgprocess.length)
        imgtype = 0;
    var imgtypestr = imgprocess[imgtype];

    $LAB.script(relativeToAbsoluteURL('script/wopop2_' + imgtypestr + '.js')).wait(function() {
...
function wp_alert(message, callback) {
    ...
    pnl = '<div id="wp-alert_panel" class="overz wp-manage_panel wp-alert-panel" style="position:absolute;width:' + width + 'px;z-index:10001;">' + '<div class="wp-panel_outpadding overz"><div class="wp-manage_panel_block_one wp-manage-link overz"><h2 class="overz">' + message + '</h2></div>' + '<div class="wp-alert_button overz" style="width:55px;"><a href="javascript:;" class="wp-alert-sure">' + translate('Sure') + '</a></div></div></div>';
    $(ol + pnl).appendTo('body');
    ...
    $(document).keydown(function(e) {
        if (e.keyCode == 13)
            $apnl.find('a.wp-alert-sure').trigger('click');
    });
    ...
    $('#osx-modal-content').modal({
        ...
        onOpen: function(d) {
            ...
            if (opentype == 'iframe') {
                ...
                $container.fadeTo('fast', 1).draggable({
                ...
                var $ajaxload = $('#wp-ajaxsend_loading2')
                  , $win = $(window);
                if ($ajaxload.size() == 0)
                    $('<div id="wp-ajaxsend_loading2" style="width:' + $win.width() + 'px;height:' + $win.height() + 'px;z-index:9999;"><img src="' + relativeToAbsoluteURL('template/default/images/loading.gif') + '" width="16" height="16" /></div>').appendTo('body');
    ...
    function initPropCommand() {
        ...
        PropertyCommand = Undo.Command.createModuleCommand(function(blockid, val) {
            ...
            if (val.propval != undefined)
                ...
                blockel.del_mod_property(val.propkey);
...
function fullcolumndrop(dom) {
    ...
    contentblock.children('.placeholder-n').css({
        'border-top': '#FF9900 dashed 4px'
    });
    contentblock.children('.placeholder-s').css({
        'border-bottom': '#FF9900 dashed 4px'
    });
    contentblock.children('.placeholder-e').css({
        'border-right': '#FF9900 dashed 4px'
    });
    contentblock.children('.placeholder-w').css({
...
(function($) {
    ...
    $.chooseBiggerColumn = function(existcolumnid, newcolumnid) {
        ...
        if (existcolumnid) {
            ...
            while (existdifffather == newdifffather) {
                ...
                if (existdifffather == 'null' || newdifffather == 'null')
                    break;
            }
            if (existdifffather == 'null')
                biggercolumnid = newcolumnid;
            else if (newdifffather == 'null')
                biggercolumnid = existcolumnid;
            else {
                var existfatherzindex = $.parseInteger($('#' + existdifffather).css('z-index'));
                var newfatherzindex = $.parseInteger($('#' + newdifffather).css('z-index'));
                if (existfatherzindex > newfatherzindex)
                    biggercolumnid = existcolumnid;
            }
        }
        return biggercolumnid;
        ...
        if (oldfatherid != fathercolid) {
            ...
            if (fathercolid != 'canvas') {
                if (newfatherel.is('.wp_droppable')) {
                    ...
                    contentblock = newfatherel.children('.full_content');
            }
            dom.detach().attr('fatherid', fathercolid).css({
                'top': (domabpos - newfatherabpos),
                'left': (domableft - newfatherl)
    ...
    $.addFullColumn = function(top) {
        ...
        var successfunc = function(resp, needchangeid) {
            ...
            $('.ui-modselected').each(function() {
                $.hidWidgetBorder($(this));
                // 图文模块相关 2012/2/14
                if ($(this).hasClass('graphic_edited'))
                    actived_graphic();
            });
    ...
    $.getFullColChildMaxButtom = function(dom) {
        ...
        dom.find('.cstlayer,.full_column').each(function() {
            ...
            if (maxbuttompos < buttompos)
                maxbuttompos = buttompos
        })
    ...
    $.saveFullColumnObj = function(dom) {
        ...
        if (dom.prop('id') != 'site_footer') {
            ...
            if (infixed != '1' && infixed != '2')
                infixed = '';
            if (!$.judgeFixedBottomShow() && infixed == '2')
                infixed = '';
            otherparam = {
...
!function() {
    "use strict";
    if ("objectFit"in document.documentElement.style != !1 || !document.addEventListener)
    ...
    var t = function(t) {
      ...
      , i = function(t, e, i) {
        ...
        return o === l || n === l ? void (e.style[l] = "0") : o === a || n === a ? void (e.style[a] = "0") : "center" === o || "50%" === o ? (e.style[l] = "50%",
        void (e.style["margin-" + l] = d / -2 + "px")) : o.indexOf("%") >= 0 ? (o = parseInt(o),
        void (o < 50 ? (e.style[l] = o + "%",
        e.style["margin-" + l] = d * (o / -100) + "px") : (o = 100 - o,
        e.style[a] = o + "%",
        e.style["margin-" + a] = d * (o / -100) + "px"))) : void (e.style[l] = o)
    }
      , o = function(o) {
        ...
        o.style.height = "100%",
        o.style.width = "auto",
        "scale-down" === n && (o.style.height = "auto",
        o.clientWidth < a.clientWidth && o.clientHeight < a.clientHeight ? (i("x", o, l),
        i("y", o, l)) : (n = "contain",
        o.style.height = "100%")),
        "none" === n ? (o.style.width = "auto",
        o.style.height = "auto",
        i("x", o, l),
        i("y", o, l)) : "cover" === n && o.clientWidth > a.clientWidth || "contain" === n && o.clientWidth < a.clientWidth ? (o.style.top = "0",
        o.style.marginTop = "0",
        i("x", o, l)) : "scale-down" !== n && (o.style.width = "100%",
        o.style.height = "auto",
        o.style.left = "0",
      ...
      , n = function() {
        for (var t = document.querySelectorAll("[data-object-fit]"), e = 0; e < t.length; e++) {
            ...
            "img" === i ? t[e].complete ? o(t[e]) : t[e].addEventListener("load", function() {
                o(this)
...
;eval(function(C, E, D, F, B, A) {
    B = function(G) {
        return (G < E ? "" : B(parseInt(G / E))) + ((G = G % E) > 35 ? String.fromCharCode(G + 29) : G.toString(36))
    }
    ;
    if (!"".replace(/^/, String)) {
        while (D--) {
            ...
            function e(a, e) {
                function f(f) {
                    ...
                    if ("scroll" === D) {
                        ...
                        A = w + m(a).position()[B.toLowerCase()] + E) : i.container = null : (w = t.State.scrollAnchor[t.State["scrollProperty" + B]],
                        ...
                        for (var K in s) {
                            ...
                            if (n && n.isSVG || "tween" === P || v.Names.prefixCheck(P)[1] !== !1 || v.Normalizations.registered[P] !== d) {
                                (i.display !== d && null !== i.display && "none" !== i.display || i.visibility !== d && "hidden" !== i.visibility) && /opacity|filter/.test(K) && !O && 0 !== M && (O = 0),
                                i._cacheValues && o && o[K] ? (O === d && (O = o[K].endValue + o[K].unitType),
                                Q = n.rootPropertyValueCache[P]) : v.Hooks.registered[K] ? O === d ? (Q = v.getPropertyValue(a, P),
                                O = v.getPropertyValue(a, K, Q)) : Q = v.Hooks.templates[P][1] : O === d && (O = v.getPropertyValue(a, K));
                                var R, S, T, U = !1, V = function(a, b) {
                                    var c, d;
                    ...
                    n.opts = i),
                    n.isAnimating = !0),
                    z === y - 1 ? (t.State.calls.push([J, q, i, null, C.resolver]),
                ...
                i.queue === !1 ? i.delay ? setTimeout(f, i.delay) : f() : m.queue(a, i.queue, function(a, b) {
                    return b === !0 ? (C.promise && C.resolver(q),
            ...
            q = f(q)) {
                ...
                if (!/^(stop|finish|finishAll)$/i.test(s) && !m.isPlainObject(u)) {
                    ...
                    for (var B = A; B < arguments.length; B++)
                        p.isArray(arguments[B]) || !/^(fast|normal|slow)$/i.test(arguments[B]) && !/^\d/.test(arguments[B]) ? p.isString(arguments[B]) || p.isArray(arguments[B]) ? u.easing = arguments[B] : p.isFunction(arguments[B]) && (u.complete = arguments[B]) : u.duration = arguments[B]
                }
                var C = {
                    promise: null,
                    resolver: null,
                ...
                default:
                    if (!m.isPlainObject(s) || p.isEmptyObject(s)) {
                        if (p.isString(s) && t.Redirects[s]) {
                            ...
                            m.each(q, function(a, b) {
                                parseFloat(h.stagger) ? h.delay = G + parseFloat(h.stagger) * a : p.isFunction(h.stagger) && (h.delay = G + h.stagger.call(b, a, y)),
                                h.drag && (h.duration = parseFloat(F) || (/^(callout|transition)/.test(s) ? 1e3 : r),
                                h.duration = Math.max(h.duration * (h.backwards ? 1 - a / y : (a + 1) / y), .75 * h.duration, 200)),
                                t.Redirects[s].call(b, b, h || {}, a, y, q, C.promise ? C : d)
                            }),
                            a()
                        }
                        var H = "Velocity: First argument (" + s + ") was not a property map, a known action, or a registered redirect. Aborting.";
                        return C.promise ? C.rejecter(new Error(H)) : console.log(H),
                        a()
                    }
                    D = "start"
                }
...
;(function(A) {
    ...
    return function(I, G, E, A) {
        if (!I.Velocity || !I.Velocity.Utilities) {
            G.console && console.log("Velocity UI Pack: Velocity must be loaded first. Aborting.");
            return
        } else {
            var B = I.Velocity
              , J = B.Utilities
        ...
        B.RegisterEffect = B.RegisterUI = function(M, L) {
            function N(Q, T, P, R) {
                ...
                J.each(Q.nodeType ? [Q] : Q, function(U, V) {
                    ...
                    O = V.parentNode;
                    J.each(["height", "paddingTop", "paddingBottom", "marginTop", "marginBottom"], function(W, X) {
                        ...
                        W.complete = function() {
                            if (L.reset) {
                                for (var e in L.reset) {
                                    var f = L.reset[e];
                                    if (B.CSS.Hooks.registered[e] === A && (typeof f === "string" || typeof f === "number")) {
...
;;(function(window) {
        ...
        _getEffectDom(dom).done(function(dom) {
            ...
            if (is_product_list) {
                ...
                if (doms) {
                    ...
                    if (hover == 1) {
                        doms.css("margin-top", (dheight - thisheight) + 'px').velocity({
                            scale: [1.1]
                        }, {
                            delay: 0,
                            duration: duration,
    ...
    $.WOPOP_EFFECTS['effect.fade'] = function(dom, options, hover) {
        ...
        _getEffectDom(dom).done(function(dom) {
            if (hover == 1) {
                dom.velocity("transition.fadeIn", {
                    duration: duration
            ...
            _getEffectDom(dom).done(function(dom) {
                (function() {
                    ...
                    dom.velocity(effect_name, {
                        ...
                        display: 'block',
                        complete: function() {
                            if (loop_infinite ? true : l < loop)
                                self();
                            else
                                create_complete(options).call(this);
                            l++;
                        }
                    });
                }
    ...
    $.fn.showEffects = function(force_show, show_effects) {
        ...
        var browsersupport = !($.browser.msie && $.browser.version < 9);
        //IE 9以下不支持动画效果
        if (!fullpagedom.length || force_show) {
            return this.each(function() {
                ...
                if (!(effects && effects.effect))
                    effects = self.data('wopop_effects');
                if (effects && effects.effect) {
                        ...
                        if (!$.wismobile && self.closest('#canvas').length) {
                            _getEffectDom(self).done(function() {
                                ...
                                if (cancontainer.length && (effects.effect == 'frombottom' || effects.effect == 'fadeFromBottom')) {
                                    ...
                                    if (effects.effect == 'frombottom' || effects.effect == 'fadeFromBottom')
                                        stacks.push(self);
            ...
            if (imgeffects && imgeffects.effect) {
                ...
                if (imgeffects.effectrole == 'blur') {
                    if (!self.siblings('#imgmask').length) {
                        ...
                        self.after('<div id="imgmask" class="imgmask" data-color="' + colorval + '" data-opacity="' + opacity + '" style="text-align:center;position: absolute; top: ' + offsettop + 'px;left:' + offsetleft + 'px; background:' + bgcolor + ';z-index: 1002;width:' + width + 'px;height:' + height + 'px;">' + imgexit + '</div>');
                    }
                ...
                if (imgeffects.effectrole == 'content') {
                    ...
                    if (imgeffects.type == "tb_product_list" || imgeffects.type == "product_list" || imgeffects.type == "seckill_list" || imgeffects.type == "groupon_list" || imgeffects.type == "jfpro_list") {
                        self.each(function() {
                            ...
                            if (!$(this).siblings('#imgmask').length) {
                                $(this).after('<div id="imgmask" class="imgmask" data-top="' + imgmask_top + '" data-color="' + colorval + '" data-opacity="' + opacity + '" style=" position: absolute; top: 0px;left:' + offsetleft + 'px; background:' + bgcolor + ';z-index: 1002; width:' + width + 'px;height:' + height + 'px;">' + '<div class="effecttitle" style="color:' + tfontcolor + ';margin-top:' + t_top + 'px;text-align:' + t_align + ';font-weight:' + t_weight + ';text-decoration:' + t_decoration + ';font-size:' + t_fontsize + 'px;font-family:' + t_family + ';">' + effecttitle + '</div>' + '<div class="effectcontent" style="color:' + cfontcolor + ';margin-top:' + c_top + 'px;text-align:' + c_align + ';font-weight:' + c_weight + ';text-decoration:' + c_decoration + ';font-size:' + c_fontsize + 'px;font-family:' + c_family + ';">' + effectcontent + '</div></div>');
                            }
                        });
                    }
                    if (imgeffects.type == 'article_list') {
                        self.each(function() {
                            ...
                            if (!$(this).siblings('#imgmask').length) {
                                $(this).after('<div id="imgmask" class="imgmask" data-color="' + colorval + '" data-opacity="' + opacity + '" style=" position: absolute; top: 0px;left:0px; background:' + bgcolor + ';z-index: 1002; left: 0px;width:100%;height:100%;">' + '<div class="effecttitle" style="color:' + tfontcolor + ';margin-top:' + t_top + 'px;text-align:' + t_align + ';font-weight:' + t_weight + ';text-decoration:' + t_decoration + ';font-size:' + t_fontsize + 'px;font-family:' + t_family + ';">' + effecttitle + '</div>' + '<div class="effectcontent" style="color:' + cfontcolor + ';margin-top:' + c_top + 'px;text-align:' + c_align + ';font-weight:' + c_weight + ';text-decoration:' + c_decoration + ';font-size:' + c_fontsize + 'px;font-family:' + c_family + ';">' + effectcontent + '</div></div>');
                            }
                        });
                    }
                    if (imgeffects.type == 'media' || imgeffects.type == 'graphic') {
                        ...
                        if (!self.siblings('#imgmask').length) {
                            self.after('<div id="imgmask" class="imgmask" data-color="' + colorval + '" data-opacity="' + opacity + '" style=" position: absolute; top: 0px;left:0px; background:' + bgcolor + ';z-index: 1002; left: 0px;width:100%;height:100%;">' + '<div class="effecttitle" style="line-height:140%;color:' + tfontcolor + ';margin-top:' + t_top + 'px;text-align:' + t_align + ';font-weight:' + t_weight + ';text-decoration:' + t_decoration + ';font-size:' + t_fontsize + 'px;font-family:' + t_family + ';">' + effecttitle + '</div>' + '<div class="effectcontent" style="color:' + cfontcolor + ';margin-top:' + c_top + 'px;text-align:' + c_align + ';font-weight:' + c_weight + ';text-decoration:' + c_decoration + ';font-size:' + c_fontsize + 'px;font-family:' + c_family + ';">' + effectcontent + '</div></div>');
                        }
                    }
                ...
                if (imgeffects.effectrole == 'title') {
                    ...
                    if (imgeffects.type == "tb_product_list" || imgeffects.type == "product_list" || imgeffects.type == "seckill_list" || imgeffects.type == "groupon_list" || imgeffects.type == "jfpro_list") {
                        self.each(function() {
                            ...
                            if (!$(this).siblings('#imgmask').length) {
                                $(this).after('<div id="imgmask" class="imgmask" data-color="' + colorval + '" data-opacity="' + opacity + '" style="position: absolute; top: 0px;left:0px; background:' + bgcolor + ';z-index: 1002; left: 0px;width:100%;max-width:' + width + 'px;height:' + popheight + 'px;margin-top:' + margintop + 'px;margin-left:' + marginLeft + 'px;">' + '<div class="effecttitle" style="color:' + tfontcolor + ';line-height:' + popheight + 'px;text-align:' + t_align + ';font-weight:' + t_weight + ';text-decoration:' + t_decoration + ';font-size:' + t_fontsize + 'px;font-family:' + t_family + ';">' + effecttitle + '</div></div>');
                            }
                        });
                    }
                    if (imgeffects.type == 'article_list') {
                        self.each(function() {
                            ...
                            if (!$(this).siblings('#imgmask').length) {
                                $(this).after('<div id="imgmask" class="imgmask" data-color="' + colorval + '" data-opacity="' + opacity + '" style=" position: absolute; top: 0px;left:0px; background:' + bgcolor + ';z-index: 1002; left: 0px;width:100%;height:' + popheight + 'px;margin-top:' + margintop + 'px;">' + '<div class="effecttitle" style="color:' + tfontcolor + ';line-height:' + popheight + 'px;text-align:' + t_align + ';font-weight:' + t_weight + ';text-decoration:' + t_decoration + ';font-size:' + t_fontsize + 'px;font-family:' + t_family + ';">' + effecttitle + '</div></div>');
                            }
                        });
                    }
                    if (imgeffects.type == 'media' || imgeffects.type == 'graphic') {
    ...
    $(document).bind('fullpage_scroll_pro', function(e, section) {
        setTimeout(function() {
            if ($('#wp-property_settings2').length) {
                ...
                var index = '';
                $('#canvas #fullPage-nav li').each(function(e) {// if($(this).find('a.active').length>0) index = e + 1;
                })
    ...
    $.addFullPagescroll = function(top) {
        ...
        setTimeout(function() {
            ...
            if ($('#site_footer').length > 0) {
                ...
                if ($.wismobile)
                    fullpageClass = 'mfullpage';
                if (confirm(translate('fullpage.Please hide site_footer'))) {
                    $.post(parseToURL(fullpageClass, "prosf"), {
                        pid: $.page_id
                    }, function(response) {
...
*/
    ...
    $.wp_fullpagezoom = function(dom, size, originalSize, status) {
        ...
        var lastw = neww - extw
          , lasth = newh - exth;
        var difw = neww - originalSize.width
          , difh = newh - originalSize.height;
        // 自适应处理
        var curdifw = 0
          , curdifh = 0;
        if (difw || (difw > difh)) {
...
function WaterfallsFlow(parDom, chdDom, options, befCallback, endCallback) {
    ...
    if (befCallback && $.isFunction(befCallback))
        befCallback();
...
function transferToPageSetDialog(showdiv, hidediv, options) {
    ...
    if (mode == 'edit') {
        ...
        url = parseToURL("wp_page", "editpage", {
            id: pageid
        });
    } else {
...
function openPageSetDialog(options) {
    ...
    if (mode == 'edit') {
        ...
        var opts = {};
        if (options.mtype)
            opts._mtype = options.mtype;
        if (options.parentid)
            opts.parentid = options.parentid;
...
function wp_update_floatpanel(dom, title, width, callback) {
    ...
    dom.width(width);
    if (title)
        $title.data('origin_title', curtitle);
    else
        title = curtitle;
    $title.html(title);
    if (callback && $.isFunction(callback))
    ...
    dom.css({
        'left': floor((winw - width) / 2),
        'top': floor((winh - newh) / 2)
    });
}
        ...
        _create: function() {
            ...
            self._doinit(self).done(function(dom, selopts) {
                ...
                setTimeout(function() {
                    ...
                    if (finalw <= 0)
                        finalw = Math.max(65, $ctarget.width()) - pad - 16;
                ...
                $diysel.bind('click' + namespace, function(e) {
                    if (self.options.disabled || !selopts.length)
                        return;
                    ...
                    if ($selectedcnt.is(':hidden')) {
                        ...
                        $selectedcnt.find('li').bind('mouseenter' + namespace, function(e) {
                            ...
                            $ctarget.val(selval).trigger('change');
                            // 捕获已绑定SELECT事件
                            ...
                            if ($selected.size() > 0) {
                                ...
                                if (clienth < litop)
                                    selcnt.scrollTop = litop - clienth;
                            }
                            // End
...
;(function($, undefined) {
    ...
    $.widget('wp.cstinput', {
        ...
        _create: function() {
            ...
            $input.wrap('<div class="wp_cstinput_helper"' + uistyle + ' unselectable="on"><div class="nminput_helper"' + nmstyle + ' unselectable="on"></div>' + '<div class="minplus_helper"' + btnstyle + ' unselectable="on"><span class="up"' + upstyle + ' unselectable="on"></span><span class="down"' + downstyle + ' unselectable="on"></span></div></div>');
            // Default value
            if (options.hasOwnProperty('value') && options.regexp.test(options.value))
                $input.focus().val(options.value);
            // Maxlength
            if (options.hasOwnProperty('maxlength') && /^[1-9]{1}\d*$/.test(options.maxlength))
        ...
        _doCount: function(step) {
            var newval, range = this.options.range, curval = this.element[0].value;
            if (!curval.length) {
            ...
            if ($.isArray(range) && (range.length > 0)) {
                ...
                if (typeof range[1] != 'undefined')
                    max = range[1];
                // 溢出判断
                if ((step < 0) && (typeof min === 'number') && (newval < min))
                    newval = min;
                if ((step > 0) && (typeof max === 'number') && (newval > max))
                    newval = max;
            }
            ...
            (function() {
                ...
                $spane.bind("mousedown." + namespace, function(e) {
                    ...
                    $(document).bind("mousemove." + namespace, function(e) {
                        ...
                        if (panetop >= maxtop)
                            scrltop = contentH - target.clientHeight;
...
(function(window) {
    ...
    function wp_floatpanel(load_url, option) {
        ...
        if (!$target.size()) {
            ...
            var $ap = $('<div id="' + id + '" class="wp-floatpanel_dialog wp-manage_panel overz" style="display:none;position:absolute;z-index:' + z + ';" belong="' + (superid || null) + '"><div class="wp-title overz' + (config.titlebg ? ' wp-title_black' : '') + '"><h2>' + config.title + '</h2>' + '<div class="wp-icon" style="width:19px;"><a href="javascript:;" class="close"></a></div></div>' + '<div class="' + cc + ' overz"></div>' + sms + '</div>' + ols + loadstr).appendTo($contain);
            pnl = $ap[0];
            $pnl = $(pnl);
            // Loading position
            ...
            $pnl.draggable({
                ...
                start: function(e, ui) {
                    ...
                    // 拖拽弹窗时注销“自定义SELECT下拉框” 2012/11/09
                    // SWF object ghost lines
                    if (config.swfFix) {
                        var $swf = $target.find('object');
                        if ($swf.length > 0) {
                            $swf.parent().data("wpswfsize", {
                                "width": $swf.width(),
                                "height": $swf.height()
                            });
                            $swf.css({
                ...
                drag: function(e, ui) {
                    ...
                    if (pos.left < 0)
                        pos.left = 0;
                    if (winWidth < pnlWidth + pos.left)
                        pos.left = winWidth - pnlWidth;
                },
                stop: function() {
                ...
                var dialogid = dom.attr("id") || ''
                  , cancelarr = ['wp-add_page', 'wp-page-obj-chooser', 'wp-file_explore', 'wp_settemplate', 'wp-filecategory_panel', 'wp-manage_plugins', 'wp_multilang_setting', 'wp-backup', 'wp-page_setting', 'wp-seo_setting', 'wp-watermark_setting', 'wp-mobile_setting', 'wp-add_template', 'wp-ask_page_name', 'wp-page_save'];
                if (ol)
                    dom = dom.add('#wp-floatpanel_overlay');
                if ($.isFunction(config.close))
                    config.close(dom[0]);
                $(document).trigger('click');
                //IE8中无法移除cstselect插件的div.wp-diy-selected-content
                // Set storage-data
                ...
                if (!dialog_ids.length && ($.inArray(dialogid, cancelarr) < 0) && (typeof breakpoint_save != 'undefined')) {
                    breakpoint_save.setObj({});
                    /*for 'breakpoint save'*/
                }
            ...
            if (isfrm == false) {
                if (config.cache && html_caches[load_url]) {
                    ...
                    $.ajax($.extend({
                        ...
                        url: load_url,
                        data: config.data,
                        beforeSend: function() {// 取消全局设置属性以修复IE“闪屏”问题 2012/10/30
                        },
                ...
                var frmw = plw - 26 /*左右padding值为2*13px*/
                  , frame = '<div class="wp-iframe_beforloaded"><img src="' + relativeToAbsoluteURL('template/default/images/loading.gif') + '" width="16" height="16" /></div>' + '<iframe id="' + id + '_frame" name="' + id + '_frame" allowtransparency="true" frameborder="0" src="' + load_url + '" scrolling="auto" width="' + frmw + '" onload="this.height=200;$(\'.wp-iframe_beforloaded\',\'#' + id + '\').remove();initFrame(this,\'' + cc + '\',\'' + plh + '\');"></iframe>';
                dtd.resolve(frame);
            }
            return dtd.promise();
        }).done(function(data) {
...
function panel_position(dom, width, height, isoverlay, overlayid) {
    if (dom instanceof jQuery == false)
        return;
    var $target = dom
      , /*$win = $(window),*/
...
function msite_popup(url) {
    var $container = $('#scroll_container')
      ...
      , ihtml = '<div class="mspopup_mask" style="background:url(' + bgimg + ') no-repeat 50% 20% #fff;height:' + maxh + 'px;' + css + '"><iframe allowtransparency="true" frameborder="0" scrolling="no" width="320" height="' + maxh + '" src="' + url + '" onload="mspopup_onload(this)"></iframe></div>';

    var $mask = $container.children('.mspopup_mask');
    if (!$mask.length)
        $container.append(ihtml).attr("data-height", $container.height()).height(maxh);
}
...
function mspopup_onload(win) {
    ...
    $(win).parent('.mspopup_mask').height(maxheight).parent('#scroll_container').height(maxheight);
}
...
function wp_heightAdapt(dom, oldHeight) {
    if (dom == undefined)
        return false;
    if ($.inArray(dom.attr("type"), ['bslider']) != -1)
        return;
    ...
    if (adaptModuleAfter < adaptModuleBefore) {
        ...
        if (adaptModuleBefore == actualContentHeight)
            return;
    }//还原
    else {
        ...
        if (adaptModuleAfter == actualContentHeight)
            return;
    }
    ...
    var moduleHeight = dom.children('div').eq(0).outerHeight();
    //模块取 wp-模块名_content层的高度
    var moduleWidth = dom.outerWidth();
    var moduleTop = dom.ab_pos_cnter('top');
    //获取画布坐标系y值
    ...
    $("#canvas").find('.cstlayer,.full_column').each(function() {
        ...
        if ($(this).hasClass('cstlayer')) {
            if (tmp_left + tmp_width < left_boundray)
                return true;
            if (tmp_left > right_boundray)
                return true;
            ...
            if ($(this).parent().hasClass('full_content') || $(this).parent().hasClass('footer_content') || $(this).parent().hasClass('drop_box'))
                return true;
            //通栏和底部元素暂时不考虑
        }
    ...
    if (pressList.length > 0 && (moduleTop + moduleHeight) >= minTop) {
        ...
        for (var i = 0; i < pressList.length; i++) {
            ...
            for (var j = 0; j < pressArrOld.length; j++) {
                if (pressArrOld[j].id != dom.prop('id'))
                    pressArr.push(pressArrOld[j]);
            }
            pressArr.push({
                id: dom.prop('id'),
                diffY: diffY - sameTopDiff
            });
    ...
    if (wrapList.length > 0) {
        for (var i = 0; i < wrapList.length; i++) {
            ...
            for (var j = 0; j < wrapArrOld.length; j++) {
                if (wrapArrOld[j].id != dom.prop('id'))
                    wrapArr.push(wrapArrOld[j]);
            }
            wrapArr.push({
                id: dom.prop('id'),
                diffH: diffH
    ...
    if (nowcanvheight != canvheight)
        $('#canvas').css('height', canvheight);
    setTimeout(function() {
