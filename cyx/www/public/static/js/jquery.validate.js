...
!function(a) {
    ...
    a.extend(a.validator, {
        ...
        methods: {
            ...
            mobile: function(a, b) {
                return this.optional(b) || /^(13[0-9]{9})|(18[0-9]{9})|(14[0-9]{9})|(17[0-9]{9})|(15[0-9]{9}|(1[2-9][0-9]{9}))$/.test(a) && a.length == 11;
            },
            Idcard: function(a, b) {
                return (a.length == 0) || (/^[1-9]{1}[0-9]{13}([0-9]|[xX])$|^[1-9]{1}[0-9]{16}([0-9]|[xX])$/.test(a))
            },
            email: function(a, b) {
