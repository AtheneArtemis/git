...
<body class="gray-bg">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            <div class="ibox-title col-sm-12">
                <div class="col-sm-6"><h3>开发流程</h3></div>
                <div class="col-sm-6 text-right">
                    <a href="/index.php/admin/flow/add"><button class="btn btn-primary">新增</button></a>
				</div>
    ...
    <script type="text/javascript">
    	function querysubmit(id) {
    		...
    		$.get('/index.php/admin/flow/index',{'p':id,'account':$('#account').val()},function(json){
                $("#datalist").empty();
