    ...
    <div id='layerD92D99C73DA8F30432197CC8CCC81ED0' type='article_category'  class='cstlayer' style='left: 0px; top: 0px; position: absolute; z-index: 139; width: 1200px; height: 50px;'  mid=""  fatherid='layer40198511F6332DF6F231A2349F92696B'   deg='0'>
      <div class="wp-article_category_content" id="wp-atype_layerD92D99C73DA8F30432197CC8CCC81ED0" style="border-color: transparent; border-width: 0px; width: 1200px; height: 50px;"> 
        ...
        <ul id="nav_layerD92D99C73DA8F30432197CC8CCC81ED0" class="navigation">
          <li style="width:50%;z-index:2;"  class="wp_subtop"  pid="12" ><a class="  " href="/index.php/index/news/index"  ><span style="display:block;overflow:hidden;">行业新闻</span></a></li>
          <li style="width:50%;z-index:2;"  class="wp_subtop"  pid="1" ><a class="  " href="/index.php/index/news/index"  ><span style="display:block;overflow:hidden;">公司动态</span></a></li>
        </ul>
      ...
      <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <li class="wpart-border-line" style=" margin-bottom:45px;padding-bottom:45px;">
          <div class="wp-new-article-style-01-left" style="height:150px;width:240px;text-align:center;position: relative;overflow: hidden">
            ...
            <a href="/index.php/index/news/article/id/<?php echo $v['id']; ?>"><img onload="set_thumb_layerA1D998D55A012C2791F039D132C196AC(this);" src="<?php echo $uploadurl; ?><?php echo $v['thumbpicture']; ?>" class="wp-article_list-thumbnail img_lazy_load" style="position: relative;height:150px;width:240px;"/></a>
          </div>
          <!--wp-new-article-style-01-left-->
          <div class="wp-new-article-style-01-right">
            <p class="title"> <span class="category">[<?php echo $v['articletype']['name']; ?>]</span> <a href="/index.php/index/news/article/id/<?php echo $v['id']; ?>"><?php echo $v['title']; ?></a> </p>
            <p class="time"><span class="wp-new-ar-pro-time"><?php echo date('Y-m-d',$v['publishtime']); ?></span></p>
            <p class="abstract"><?php echo $v['intro']; ?></p>
