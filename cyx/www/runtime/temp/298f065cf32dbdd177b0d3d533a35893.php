            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title col-sm-12">
                        <?php if($list['id'] > 0): ?>
                            <div class="col-sm-9"><h3>编辑定制服务标题</h3></div>
                        <?php else: ?>
                            <div class="col-sm-9"><h3>新增定制服务标题</h3></div>
                        <?php endif; ?>
                        <div class="col-sm-3 text-right">
                            <a href="/index.php/admin/servicetitle/index">
                    ...
                    <div class="ibox-content"> 
                        <?php if($list['id'] > 0): ?>
                            <form method="post" class="form-horizontal" action="/index.php/admin/servicetitle/update" enctype="multipart/form-data">
                        <?php else: ?>
                            <form method="post" class="form-horizontal" action="/index.php/admin/servicetitle/insert" enctype="multipart/form-data">
                        <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="tablename">
                                        <option value="flow">开发流程</option>
                                        <option value="advantage">我们的优势</option>
                                        <option value="customization">定制开发服务</option>
                                    </select>
                                    <!-- <input type="text" class="form-control" name="tablename" value="<?php echo $list['tablename']; ?>"> -->
                                </div>
                            </div>
                            <div class="form-group">
