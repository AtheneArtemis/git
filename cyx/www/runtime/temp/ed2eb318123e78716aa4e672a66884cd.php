                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title col-sm-12">
                        ...
                        <div class="col-sm-3 text-right">
                            <a href="/index.php/admin/customer/index">
                    ...
                    <div class="ibox-content"> 
                        <?php if($list['id'] > 0): ?>
                            <form method="post" class="form-horizontal" action="/index.php/admin/customer/update" enctype="multipart/form-data">
                        <?php else: ?>
                            <form method="post" class="form-horizontal" action="/index.php/admin/customer/insert" enctype="multipart/form-data">
                        <?php endif; ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="customertype_id" class="form-control">
                                        <?php if(is_array($customertype) || $customertype instanceof \think\Collection || $customertype instanceof \think\Paginator): $i = 0; $__LIST__ = $customertype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $v['id']; ?>" <?php if($list['customertype_id'] == $v['id']): ?>selected<?php endif; ?> ><?php echo $v['name']; ?></option>
