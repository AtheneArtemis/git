<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"F:\Sublime Project\0002cyx\cyx/application/admin\view\Login\login.html";i:1555467359;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <div class="m-b"></div>
                    <h4>欢迎使用 <strong>宸亦轩管理后台</strong></h4>
                    <!-- <ul class="m-b">
            ...
            <div class="col-sm-5" style="background:#f6f6f6;filter:alpha(opacity=90);opacity:0.90;">
                <form method="post" action="" id="loginform">
                    ...
                    <p class="m-t-md" style="color:#5a5a5a;font-size:16px;">登录到宸亦轩管理后台</p>
