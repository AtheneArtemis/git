            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title col-sm-12">
                        <?php if($list['id'] > 0): ?>
                            <div class="col-sm-9"><h3>编辑开发流程</h3></div>
                        <?php else: ?>
                            <div class="col-sm-9"><h3>新增开发流程</h3></div>
                        <?php endif; ?>
                        <div class="col-sm-3 text-right">
                            <a href="/index.php/admin/flow/index">
                    ...
                    <div class="ibox-content"> 
                        <?php if($list['id'] > 0): ?>
                            <form method="post" class="form-horizontal" action="/index.php/admin/flow/update" enctype="multipart/form-data">
                        <?php else: ?>
                            <form method="post" class="form-horizontal" action="/index.php/admin/flow/insert" enctype="multipart/form-data">
                        <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="color" value="<?php echo $list['color']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
	...
	function del(id){
		if (confirm('确认删除该条记录？')) {
			$.post('/index.php/admin/flow/delete',{id:id},function(json){
				alert(json.msg);
				if (json.code == 0) {
					window.location.href = '/index.php/admin/flow/index';
				}
			},'json')
		}
	}
	...
	function shiftdelete(id){
		if (confirm('确认删除该条记录,删除后不可恢复？')) {
			$.post('/index.php/admin/flow/shiftdelete',{id:id},function(json){
				alert(json.msg);
				if (json.code == 0) {
					window.location.href = '/index.php/admin/flow/index';
				}
	...
	function multidel(){
		...
		if (confirm('确认删除选中记录？')) {
			$.post('/index.php/admin/flow/multidelete',{ids:ids},function(json){
				alert(json.msg);
				if (json.code == 0) {
					window.location.href = '/index.php/admin/flow/index';
				}
